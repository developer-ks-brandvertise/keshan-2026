...
export default function Footer() {
  return (
    <footer className="relative overflow-hidden bg-dark-950 text-text-primary">
      ...
      />
      <p
        className="pointer-events-none absolute bottom-16 left-1/2 -translate-x-1/2 select-none font-heading text-[18vw] font-medium leading-none tracking-[-7px] text-dark-100/[0.04] whitespace-nowrap lg:bottom-20 lg:text-[12rem]"
        aria-hidden
      >
        KESHAN
      </p>
