...
export default function Hero() {
  ...
  return (
    <section className="relative flex min-h-[calc(100vh-7rem)] items-start overflow-hidden bg-[#050505] pt-[8vh] lg:pt-[10vh]">
      ...
      {/* Always dark cinematic overlays — do not use theme tokens (light mode would wash out video) */}
      <div
        className="pointer-events-none absolute inset-0 bg-gradient-to-b from-black/60 via-black/40 to-black/80"
        aria-hidden
      />
      <div
        className="pointer-events-none absolute inset-0 bg-[radial-gradient(ellipse_at_50%_40%,transparent_20%,rgba(5,5,5,0.6)_100%)]"
        aria-hidden
      />
