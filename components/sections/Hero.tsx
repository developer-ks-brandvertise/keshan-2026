      ...
      <Container className="relative z-10 py-20 lg:py-28">
        <div className="mx-auto max-w-4xl text-center">
          <motion.h1
            ...
            className="font-heading text-4xl font-medium leading-[1.05] tracking-[-2px] text-white drop-shadow-[0_2px_8px_rgba(0,0,0,0.6)] sm:text-5xl md:text-6xl lg:text-7xl"
          >
