        ...
        <ol className="mt-8 space-y-8">
          {items.map((item) => (
            <li key={item.id} className="border-b border-dark-100/10 pb-8 last:border-0">
              <div className="text-copper-shimmer font-heading text-2xl tracking-tight md:text-3xl">
                {item.label}
              </div>
              {item.detail ? (
          ...
          >
            {items.map((item) => (
              <li
                ...
                style={{ transformStyle: "preserve-3d" }}
              >
                <span className="text-copper-shimmer text-center font-heading text-4xl font-semibold tracking-tighter md:text-6xl lg:text-7xl">
                  {item.label}
                </span>
              </li>
            ))}
