...
export const hero = {
  ...
  video:
    "https://res.cloudinary.com/p4nrvzvp/video/upload/v1784295716/0_Abstract_Particles_1920x1080_zbif19.mp4",
  poster: "/images/bg-header01.jpg",
};
...
export const contactHeaderImage =
  "https://res.cloudinary.com/p4nrvzvp/image/upload/v1787476045/Contact-Us_tquiz7.png";

export const qualityMediaHeaderImage =
  "https://res.cloudinary.com/p4nrvzvp/image/upload/v1787476045/Quality_zp1vyv.png";

export const knowledgeCentreHeaderImage =
  "https://res.cloudinary.com/p4nrvzvp/image/upload/v1787476045/Knowledge-Center_sz1gt5.png";
  ...
  categories: [
    {
      ...
      image:
        "https://res.cloudinary.com/p4nrvzvp/image/upload/v1787477253/Copper-Product-Range_opzcjs.png",
    },
    {
      ...
      href: "/products#brass",
      image:
        "https://res.cloudinary.com/p4nrvzvp/image/upload/v1787477292/Brass-Product-Range_safoux.png",
    },
  ],
};
...
export const processSteps = [
  {
    ...
    title: "Sorting",
    description:
      "Incoming raw material is sorted and graded to ensure consistent feedstock quality before it enters the production line.",
  },
  {
    number: "02",
    title: "Baling",
    description:
      "Sorted material is baled and prepared for charging, improving furnace efficiency and melt consistency.",
  },
  {
    number: "03",
    title: "Melting & Casting",
    description:
      "High-purity material melted in modern induction furnaces, with controlled composition from the first pour.",
  },
  {
    number: "04",
    title: "Rolling & Processing",
    description:
      "Multi-pass rolling lines for precise dimensional control. Consistent cross-section. Tight tolerances.",
  },
  {
    number: "05",
    title: "Cutting & Finishing",
    description:
      "Slitting, shearing, and surface finishing to customer specification. Cut-to-length. Custom dimensions.",
  },
  {
    number: "06",
    title: "Testing & Inspection",
    description:
      "Every batch is batch-tested for conductivity, chemical composition, tensile strength, and dimensional accuracy. Certified results.",
  },
  {
    number: "07",
    title: "Packaging & Dispatch",
    description:
      "Industrial-grade packaging, moisture protection, and complete quality documentation with every shipment.",
  },
];

export const quality = {
  headline: "Quality is Not a Department at Keshan. It is the Standard.",
...
export const industries = {
  ...
  all: [
    ...
    "Switchgear, Panels & Busducts",
    "Renewable Energy & Solar Infrastructure",
    "EV, Charging & Mobility",
    "Cables, Conductors & Wire Manufacturing",
    ...
    "Hardware, Sanitaryware & Decorative",
  ],
};

export const clients = {
  headline: "Long-Term Partnerships with Leading Metallurgical Companies Worldwide.",
  caption:
    "Keshan supplies manufacturers, infrastructure developers, and metallurgical companies across the globe — partnerships built on consistent, certified copper supply, batch after batch.",
  names: [
    "Atlas Nachtergaele",
    "Snoeck Metalen",
    "MoltenSteel Works",
    "IronTherm Industries",
    "HeatSteel Solutions",
    "Berlin Central Bank",
    "Sanfran Cisco Bridge",
  ],
};
...
export const visionMission = {
  ...
  values: [
    ...
    { title: "Continuous Improvement", description: "Better processes, tighter tolerances, and stronger partnerships." },
  ],
};

export const leadership = {
  headline: "The Team Behind the Standard.",
  subheadline:
  ...
  team: [
    ...
    {
      name: "Suren Reddy",
      title: "Chief Executive Officer, Keshan Industries",
      shortBio:
        "A senior business leader with 25 years across manufacturing, international trading, and Fortune 500 global sourcing.",
      fullBio: [
        "Suren Reddy is Chief Executive Officer at Keshan Industries and a senior business leader with 25 years of diverse experience across manufacturing in metallurgy, building materials, beverages, automotive components, international trading, and global sourcing in Fortune 500 companies.",
        "His leadership approach is centered on building efficient processes, developing capable teams, leveraging technology, and creating measurable improvements in Cost, Quality and Delivery. He is a commercially driven and transformation-oriented leader capable of taking ownership of complex business operations, strengthening the supply chain, reducing structural costs, improving service levels and building scalable systems.",
        "With an MBA in International Business from a Tier 1 institute, the Indian Institute of Foreign Trade, New Delhi, he combines business education with extensive practical experience across diverse industries.",
        "At Keshan, he spearheaded the development of integrated manufacturing capabilities for Copper Ingots, Strips, Bus Bars, and the entire Wiring Division, covering the complete value chain from raw material to finished products.",
      ],
      image: "/images/Suren-Reddy.png",
      linkedIn: "#",
    },
  ],
};
...
export const globalReach = {
  ...
  capabilities: [
    "CIF, FOB, and DAP delivery terms available",
    "Complete export documentation: Certificate of Origin, Mill Test Certificate, Packing List, Invoice",
    "Experience with Letter of Credit (LC) and TT payment structures",
    "Customs clearance support for key markets",
    "Port delivery coordination: JNPT, Mundra, Chennai, Vizag",
  ],
};
