...
export const products: Product[] = [
  ...
  },
  {
    ...
    specs: [
      ...
      "Temper: Soft, Quarter Hard, Half-Hard",
  ...
  },
  {
    ...
    description:
      "Keshan brass wires are drawn from controlled brass rod for electrical hardware, fasteners, decorative work, and industrial weaving. Uniform diameter, Soft / Quarter Hard / Half-Hard temper options, and a clean surface finish support high-volume forming and winding.",
    applications: [
    ...
    metaDescription:
      "Drawn brass wires for electrical hardware, fasteners, and industrial forming. Soft, Quarter Hard, and Half-Hard temper. Request a quote from Keshan Industries.",
    imageSrc:
